...
(function() {
  var Promise, express, installCheck, setupErrorHandler, setupMiddlewares, setupRouters, setupSession, wrapPromise,
    slice = [].slice;
  ...
  express.Router.getPromise = function() {
    var args;
    args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    return this.get.apply(this, wrapPromise(args));
  };

  express.Router.postPromise = function() {
    var args;
    args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    return this.post.apply(this, wrapPromise(args));
  };

  express.Router.putPromise = function() {
    var args;
    args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    return this.put.apply(this, wrapPromise(args));
  };

  express.Router.deletePromise = function() {
    var args;
    args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
